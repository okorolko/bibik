...
exports.getInstagram = (req, res, next) => {
  ig.use({ client_id: 'eff4fac9de4e45de8373df4f40607bc1', client_secret: '63061fabbf424fa39b6911a304df9186' });
  ig.use({ access_token: '2058837146.1677ed0.15bc4cc9140b41d69adef381624d1719'});
  async.parallel({
  myRecentMedia: (done) => {
    ...
    if (err) { return next(err); }
    console.log(results.myRecentMedia[0])
    res.render('blog', {
      title: 'Blog',
